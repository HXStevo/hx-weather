...
module.exports = {
  ...
  ui: {
    ...
    winter:                  'Winter',
    // Homepage strings
    heroStrapline:           'Weniger Stress. Mehr Urlaub.',
    heroTitle:               'Wetterführer',
    heroSub:                 'Live-Wetter für beliebte Urlaubsziele — planen Sie Ihre Reise mit Zuversicht.',
    searchPlaceholder:       'Ziel suchen...',
    planYourHoliday:         'Planen Sie Ihren nächsten Urlaub',
    newTripHeader:           'Neue Reise',
    freeCancellation:        'Kostenlose Stornierung · Bestpreisgarantie',
    flyingFrom:              'Abflug von',
    outboundFlight:          'Hinflug',
    returnFlight:            'Rückflug',
    searchBtn:               'Suchen',
    holidayWeatherNow:       'Urlaubswetter jetzt',
    sortedByPopularity:      'Nach Beliebtheit sortiert:',
    sortedByWarmest:         'Nach Wärme sortiert:',
    sortedAZ:                'A–Z sortiert:',
    holidayWeatherBlog:      'Urlaubswetter-Blog',
    seeMore:                 'Mehr anzeigen →',
    weatherNearYou:          'Wetter in Ihrer Nähe',
    gettingLocalWeather:     'Ihr lokales Wetter wird abgerufen...',
    windLabel:               'Wind',
    // Footer strings
    footerBannerText:    'Stolz, Olympische und Weltrekord-Windsurfer zu unterstützen',
    footerStayInTouch:   'In Kontakt bleiben',
    footerEmailPlaceholder: 'Ihre E-Mail-Adresse',
    footerJoin:          'Beitreten',
    footerTagline:       'Weniger Stress. Mehr Urlaub.',
    footerCol1:          'Alles für Ihre Reise',
    footerAirportParking: 'Flughafenparkplatz',
    footerAirportHotels: 'Flughafenhotels',
    footerParkingHotels: 'Parken und Übernachten am Flughafen',
    footerFastTrack:     'Flughafen Fast Track',
    footerCarHire:       'Mietwagen',
    footerTransfers:     'Flughafentransfers',
    footerTravelInsurance: 'Reiseversicherung',
    footerPortParking:   'Hafenparkplatz & Hotels',
    footerCol2:          'Parken an Ihrem Flughafen',
    footerCol3:          'Übernachten an Ihrem Flughafen',
    footerCol4:          'Hilfe & Support',
    footerManageBooking: 'Meine Buchung verwalten',
    footerRefunds:       'Rückerstattungen',
    footerCol5:          'Mehr erfahren',
    ...
    footerSlavery:       'Erklärung zur modernen Sklaverei',
  },
  wmo: {
    0:  'Klarer Himmel',
    1:  'Überwiegend klar',
  ...
  blogPosts: [
    {
      ...
      wikiQuery: 'Tenerife',
      category: 'Trendige Reiseziele',
      categoryEmoji: '🌞',
      title: 'Die besten Orte für Wintersonne im Dezember',
      excerpt: 'Entfliehen Sie dem britischen Winter mit diesen warmen und sonnigen Dezember-Reisezielen. Von den Kanarischen Inseln bis Ägypten — die besten Plätze für Wintersonne.',
    },
    {
      ...
      categoryEmoji: '🗺️',
      title: 'Warum Portugal Europas bestes ganzjähriges Reiseziel ist',
      excerpt: 'Mit über 300 Sonnentagen im Jahr, spektakulärer Atlantikküste und erstklassiger Küche belohnt Portugal Besucher in jeder Jahreszeit.',
    },
    {
      slug: 'greece-in-october',
      wikiQuery: 'Santorini',
      category: 'Aktueller Blog',
      categoryEmoji: '✍️',
      title: 'Griechenland im Oktober: Warum Herbst die beste Reisezeit ist',
      excerpt: 'Die Sommermassen haben sich gelichtet, das Meer ist noch angenehm warm und das Licht wird golden. Oktober ist vielleicht der beste Monat Griechenland zu entdecken.',
    },
    {
      ...
      category: 'Packtipps',
      categoryEmoji: '🧳',
      title: 'Mittelmeer Packführer: Was Sie in jeder Jahreszeit mitnehmen',
      excerpt: 'Von leichten Schichten für einen Städtetrip im Frühling bis zu hochwirksamer Sonnencreme für Strandurlaub — genau das, was Sie für eine Mittelmeerreise brauchen.',
    },
  ],
};